   ...
   */
   ...
   while(1) {
      ...
      /*Scan neighbors*/
      {
         ...
         ((ptoffset < pt->width * pt->height) ? (void) (0) : __assert_fail("ptoffset < pt->width*pt->height", "/tmp/__clava_woven_80246099-6d13-4087-b06e-76feec5eea6c_osboxes/siftlocalmax.c", 174, __extension__ "F2D *siftlocalmax(F2D *, float, int, int, int)"));
         i = 0;
