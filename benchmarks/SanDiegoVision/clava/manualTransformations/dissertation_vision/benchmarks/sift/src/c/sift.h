...
void imsmooth5W(F2D* I_pt, float dsigma, F2D* out, int size);
void imsmooth7W(F2D* I_pt, float dsigma, F2D* out, int size);
void imsmooth8W(F2D* I_pt, float dsigma, F2D* out, int size);
void imsmooth10W(F2D* I_pt, float dsigma, F2D* out, int size);
void imsmooth13W(F2D* I_pt, float dsigma, F2D* out, int size);
