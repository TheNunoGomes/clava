...
//#define performance_gaussianss
#define baseline_gaussianss
//#define specilized_gaussians
...
**/
    ...
    **/
        ...
        **/
            ...
            //printf("2 - %dx%d\n", gss[(s+so-1)]->height, gss[(s+so-1)]->width);
        }     
            ...
            **/
            ...
            if(target_sigma > prev_sigma)
            {
                ...
                if(TMP->height == TMP->width) {
                	...
                	switch(TMP->height) {
		        	case 2160:
		        		imsmooth2160(TMP, temp, gss[o*intervals] );
		    			break;
			    	case 1080:
		        		imsmooth1080(TMP, temp, gss[o*intervals] );
		    			break;
			    	case 540:
		        		imsmooth540(TMP, temp, gss[o*intervals] );
		    			break;
			    	default:
			...
			imsmooth( gss[o*intervals+s-1+so] , dsigma, gss[o*intervals+s+so]);
	        //printf("4 - %dx%d\n", gss[o*intervals+s-1+so]->height, gss[o*intervals+s-1+so]->width);
            }    
        }
    ...
    **/
        ...
        //pow(var, 2) turned to var*var
        temp = sqrt(sigma0*pow(k,smin)*sigma0*pow(k,smin) - sigman/pow(2,omin)*sigman/pow(2,omin));
        ...
        **/
        ...
        for(o=1; o<O; o++)
        {
            ...
            **/
            ...
            //pow(var, 2) turned to var*var
            temp = sqrt(target_sigma*target_sigma - prev_sigma*prev_sigma);
